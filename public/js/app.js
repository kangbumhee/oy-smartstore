...
const App = {
  ...
  PROMPT_TEMPLATES: {
    thumbnail_closeup:
      'Extreme close-up K-beauty advertisement in the style of Korean Olive Young product thumbnails. A young beautiful Korean female model (early 20s, flawless glowing skin, soft natural makeup) fills 80% of the frame — her face is cropped from forehead to chin, shot slightly from below at a 3/4 angle. She is subtly holding or touching "{product}" by "{brand}" near her cheek/jawline. The product is small but clearly visible. BOLD SOLID COLOR BORDER (4-5% of frame width) in a vibrant primary color (coral orange, hot pink, lime green, or bright yellow) surrounds the entire image like a picture frame. Bottom-left corner has a small semi-transparent overlay area for text placement. Ultra-bright, even lighting with no harsh shadows. Magazine cover quality. The overall mood is fresh, youthful, and eye-catching. NO text, NO watermarks. Photorealistic. Vertical 1:1 aspect ratio.',
    thumbnail_closeup_male:
      'Extreme close-up K-beauty grooming advertisement in Korean Olive Young thumbnail style. A young handsome Korean male model (early-mid 20s, clean clear skin, sharp jawline) fills 80% of the frame — face cropped from forehead to chin, 3/4 angle close-up. He is confidently holding "{product}" by "{brand}" near his face. BOLD SOLID COLOR BORDER (4-5% of frame width) in a vibrant color (navy blue, forest green, charcoal, or burnt orange) frames the image. Bottom-left corner has a subtle overlay area for text. Bright, clean lighting. Magazine quality. Fresh and modern. NO text, NO watermarks. Photorealistic. 1:1 aspect ratio.',
